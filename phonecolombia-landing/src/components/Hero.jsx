...
const DEFAULT_HERO_VIDEO = `${import.meta.env.BASE_URL}imagenes/Hero/phonecolombiavideohero.mp4`;
const DEFAULT_HERO_POSTER = `${import.meta.env.BASE_URL}imagenes/Hero/phonecolombiavideohero-poster.jpg`;
    ...
    <section id="inicio" className="hero hero--fullscreen">
      <div className="hero-video-wrap">
        <video
          ...
          ref={videoRef}
          src={videoSrc || DEFAULT_HERO_VIDEO}
          poster={videoSrc ? undefined : DEFAULT_HERO_POSTER}
          preload="auto"
          autoPlay
          loop
          playsInline
        ...
        <div className="hero-container">
          <div className="hero-text page-hero-content">
            ...
            <p className="hero-subtitle">
              iPhone, AirPods y más — reacondicionados con garantía en Colombia
            </p>
